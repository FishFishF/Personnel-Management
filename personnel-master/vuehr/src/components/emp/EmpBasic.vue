<template>
  <div>
    <el-container>
      <el-header style="padding: 10px;display:flex;justify-content:space-between;align-items: center">
        <!--<div style="display: inline">
          ...
          <el-button type="primary" size="max" style="margin-left: 0px" icon="el-icon-search" @click="searchEmp">搜索
          </el-button>
      ...
      <el-main style="padding-left: 0px;padding-top: 0px">
        <div>
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-popover trigger="hover" placement="top">
                  ...
                  <p>部门: {{ scope.row.department.name }}</p >
                  <p>职位: {{ scope.row.position.name }}</p >
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <span style="margin-left: 0px">{{ scope.row.birthday | formatDate}}</span>
              </template>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-button style="padding: 3px 4px 3px 4px;margin: 2px" type="primary"
                           size="mini" @click="showadvdialogVisible(scope.row)">查看高级资料
                </el-button>
          ...
          <div style="dis0play: flex;justify-content: space-between;margin: 2px">
    ...
    <el-dialog
      ...
      custom-class="customdetailclass"
      :before-close="handleClose">
      <span>员工id:{{advemp.id}}</span>
      <span>员工名:{{advemp.name}}</span>
      <span>员工积分:{{score}}</span>
      <br><br>
      <el-popover
        placement="right"
        width="650"
        trigger="click">
        <el-table :data="appraise" >
          <el-table-column width="160" property="appContent" label="考评内容"></el-table-column>
          <el-table-column width="160" property="appDate" label="考评日期"></el-table-column>
          <el-table-column width="160" property="appResult" label="考评结果"></el-table-column>
          <el-table-column width="160" property="remark" label="备注"></el-table-column>
        </el-table>
        <el-button slot="reference">考评信息</el-button>
      </el-popover>
      <br><br>
      ...
      <el-popover
        ...
        trigger="click">
        <el-table :data="train" >
          <el-table-column width="160" property="trainContent" label="培训内容"></el-table-column>
          <el-table-column width="160" property="trainDate" label="培训日期"></el-table-column>
          <el-table-column width="160" property="remark" label="备注"></el-table-column>
        </el-table>
        <el-button slot="reference">培训信息</el-button>
      </el-popover>
      <br><br>
      ...
      <el-popover
        ...
        trigger="click">
        <el-table :data="ec" >
          <el-table-column width="160" property="ecReason" label="奖惩原因"></el-table-column>
          <el-table-column width="160" property="ecDate" label="奖惩日期"></el-table-column>
          <el-table-column width="160" property="remark" label="备注"></el-table-column>
        </el-table>
        <el-button slot="reference">奖惩信息</el-button>
      </el-popover>
      <br><br>
      ...
      <el-popover
        ...
        trigger="click">
        <el-table :data="move" >
          <el-table-column width="160" property="reason" label="调动原因"></el-table-column>
          <el-table-column width="160" property="removeDate" label="调动日期"></el-table-column>
          <el-table-column width="160" property="remark" label="备注"></el-table-column>
        </el-table>
        <el-button slot="reference">调动信息</el-button>
      </el-popover>
    </el-dialog>
...
//        delete this.emp.politicsStatus;
            ...
            async showadvdialogVisible(row){
                this.advdialogVisible=true;
                this.advemp=row;
                this.findAppraiseByEid(this.advemp.id);
                this.findTrainByEid(this.advemp.id);
                this.findEmpECByEid(this.advemp.id);
                this.findMoveByEid(this.advemp.id);
                this.findPointByEid(this.advemp.id);
            },

            findAppraiseByEid(eid){
                this.tableLoading = true;
                var _this = this;
                this.getRequest("/employee/adv/listAppraises/"+eid).then(resp=> {
                    _this.tableLoading = false;
                    if (resp && resp.status == 200) {
                        _this.appraise = resp.data;
                    }
                })
            },
            findTrainByEid(eid){
                this.tableLoading = true;
                var _this = this;
                this.getRequest("/employee/adv/listTrain/"+eid).then(resp=> {
                    _this.tableLoading = false;
                    if (resp && resp.status == 200) {
                        _this.train = resp.data;
                    }
                })
            },
            findEmpECByEid(eid){
                this.tableLoading = true;
                var _this = this;
                this.getRequest("/employee/adv/listEC/"+eid).then(resp=> {
                    _this.tableLoading = false;
                    if (resp && resp.status == 200) {
                        _this.ec = resp.data;
                    }
            ...
            findMoveByEid(eid){
                this.tableLoading = true;
                var _this = this;
                this.getRequest("/employee/adv/listMove/"+eid).then(resp=> {
                    _this.tableLoading = false;
                    if (resp && resp.status == 200) {
                        _this.move = resp.data;
            ...
            findPointByEid(eid){
                this.tableLoading = true;
                var _this = this;
                this.getRequest("/personnel/appraise/EmpPoint/"+eid).then(resp=> {
                    _this.tableLoading = false;
                    if (resp && resp.status == 200) {
